...
const player = ref([{ name: 'frohman', avatar: '/player1.png', host: true }, { name: 'frohman', avatar: '/player1.png' }, {}, {}, {}, {}, {}, {}])
  ...
  <div class="incan-gold-game">
    <div class="incan-gold-game__nav">
      ...
      <div class="incan-gold-game__control-group">
        <button class="incan-gold-game__icon-button"><img src="/help.png" alt="help"></button>
        <button class="incan-gold-game__icon-button"><img src="/setting.png" alt="setting"></button>
      </div>
    </div>
    ...
    <div class="incan-gold-game__main">
      <div class="incan-gold-game__avatars">
        <template v-for="(player, indexOfPlayer) in fistPartsOfPlayer" :key="indexOfPlayer">
      ...
      <div class="incan-gold-game__avatars">
        <template v-for="(player, indexOfPlayer) in otherPartsOfPlayer" :key="indexOfPlayer">
          <game-avatar :user="player" />
        </template>
      </div>
    </div>
