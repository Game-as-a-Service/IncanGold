...
import { IncanGoldEventDispatcher } from "../src/IncanGold/infra/IncanGoldEventDispatcher";
...
async function enforcePlayerChoices(gameId: string) {
    // const usecase = new EnforcePlayerChoicesUseCase(new IncanGoldRepository, new IncanGoldEventDispatcher);
...
async function startGame(roomId: string, playerIds: string[]) {
    ...
    // const startGameUseCase = new StartGameUseCase(new IncanGoldRepository, new IncanGoldEventDispatcher);
...
async function makeChoice(gameId: string, explorerId: string, choice: Choice) {
    ...
    // const makeChoiceUseCase = new MakeChoiceUseCase(new IncanGoldRepository, new IncanGoldEventDispatcher);
